	...
	void MoveCar(Car& car, float ftime)
	{
		...
		if (!car.path.empty())
		{
			...
			else
			{
				...
				float angle = atanf(direction.y / direction.x);
				...
				if ((*car.goal)->pos.x <= car.pos.x && (*car.goal)->pos.y >= car.pos.y)
				{
					car.pos1.x = -1 * car.pos1.x;
					car.pos1.y = -1 * car.pos1.y;

					car.pos2.x = -1 * car.pos2.x;
					car.pos2.y = -1 * car.pos2.y;

					car.pos3.x = -1 * car.pos3.x;
					car.pos3.y = -1 * car.pos3.y;

				}
				else if ((*car.goal)->pos.x <= car.pos.x && (*car.goal)->pos.y <= car.pos.y)
				{
					car.pos1.x = -1 * car.pos1.x;
					car.pos1.y = -1 * car.pos1.y;
